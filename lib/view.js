...
var DateFieldView = function (_React$Component) {
  ...
  function DateFieldView() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(DateFieldView).apply(this, arguments));
  }

  _createClass(DateFieldView, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      _moment2.default.locale(this.context.settings.locale);
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'col-sm-10' },
          disabled ? _react2.default.createElement('input', { type: 'text', className: 'form-control', disabled: true, value: value }) : _react2.default.createElement(_reactDatetime2.default, {
            value: value,
